...
export function NoteForm({ onSubmit, initialContent = "", initialColor = "#FCA5A5" }: NoteFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4" aria-label="Add new note">
      <FormField
        id="note-content"
        label="Note"
        value={content}
      ...
      <fieldset>
        <Label>Color</Label>
        <div className="flex gap-3 mt-2" role="group" aria-label="Select note color">
